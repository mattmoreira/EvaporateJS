...
import { ABORTED, PAUSED, EVAPORATING, ACTIVE_STATUSES, CANCELED, PAUSING, PENDING, COMPLETE, FAR_FUTURE, ETAG_OF_0_LENGTH_BLOB, ERROR } from "./Constants";
import { extend, defer, readableFileSize, removeAtIndex, uploadKey, dateISOString, saveUpload, getSavedUploads, removeUpload, elementText } from "./Utils";
class FileUpload {
    ...
    updateLoaded(loadedNow) {
        $_$twiz("loadedNow", loadedNow, 2171, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    onProgress() { if (![ABORTED, PAUSED].includes(this.status)) {
    ...
    stopMonitor() { clearInterval(this.progressInterval); }
    // Evaporate proxies
    startNextFile(reason) { $_$twiz("reason", reason, 3850, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); this.evaporate.startNextFile(reason); }
    evaporatingCnt(incr) { $_$twiz("incr", incr, 3922, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); this.evaporate.evaporatingCnt(incr); }
    consumeRemainingSlots() { this.evaporate.consumeRemainingSlots(); }
    getRemainingSlots() {
    ...
    start() {
        ...
        const existenceOptimized = this.con.computeContentMd5 &&
    ...
    uploadFileFromScratch(reason) {
        $_$twiz("reason", reason, 5234, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    _uploadComplete() { this.completeUpload().then(this.deferredCompletion.resolve); }
    stop() {
        ...
        return this.abortUpload()
            .then(() => { throw "User aborted the upload"; })
            .catch(reason => { $_$twiz("reason", reason, 5891, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[5885,5891]}"); self.deferredCompletion.reject(reason); });
    }
    pause(force) {
        $_$twiz("force", force, 5973, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    _startCompleteUpload(callComplete) { $_$twiz("callComplete", callComplete, 6764, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); return function () {
        const promise = callComplete ? this.completeUpload() : Promise.resolve();
        promise.then(this.deferredCompletion.resolve.bind(this));
    }; }
    _abortUpload() { if (!this.abortedByUser) {
        const self = this;
        this.abortUpload().then(() => { self.deferredCompletion.reject("File upload aborted due to a part failing to upload"); }, this.deferredCompletion.reject.bind(this));
    } }
    abortParts(pause) {
        $_$twiz("pause", pause, 7259, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        const self = this;
        const toAbort = this.partsInProcess.slice(0);
        toAbort.forEach(i => {
            $_$twiz("i", i, 7358, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[7357,7358]}");
    ...
    makeParts(firstPart?) {
        $_$twiz("firstPart", firstPart, 7719, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        ...
        function cleanUpAfterPart(s3Part) {
            $_$twiz("s3Part", s3Part, 7906, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        ...
        function resolve(s3Part) { $_$twiz("s3Part", s3Part, 8146, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); return () => {
        ...
        function reject(s3Part) { $_$twiz("s3Part", s3Part, 8467, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); return () => { cleanUpAfterPart(s3Part); }; }
    ...
    makePart(partNumber, status, size) {
        $_$twiz("partNumber", partNumber, 9247, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        $_$twiz("status", status, 9255, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        $_$twiz("size", size, 9261, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        const s3Part = {
            status,
            loadedBytes: 0,
    ...
    setStatus(s) { $_$twiz("s", s, 9528, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); this.status = s; }
    createUploadFile() {
    ...
    updateUploadFile(updates) {
        $_$twiz("updates", updates, 10104, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        const fileKey = uploadKey(this);
    ...
    completeUploadFile(xhr) {
        $_$twiz("xhr", xhr, 10304, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        const uploads = getSavedUploads();
    ...
    removeUploadFile() { if (typeof this.file !== "undefined") {
    ...
    canRetryUpload(u) {
        $_$twiz("u", u, 11279, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    partSuccess(eTag, putRequest) {
        $_$twiz("eTag", eTag, 11874, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        $_$twiz("putRequest", putRequest, 11886, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    listPartsSuccess(listPartsRequest, partsXml) {
        $_$twiz("listPartsRequest", listPartsRequest, 12486, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        $_$twiz("partsXml", partsXml, 12496, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
    ...
    makePartsfromPartsOnS3() {
        ...
        this.partsOnS3.forEach(cp => {
            $_$twiz("cp", cp, 13591, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[13589,13591]}");
    ...
    completeUpload() {
        ...
        return new CompleteMultipartUpload(this).send().then(xhr => {
            $_$twiz("xhr", xhr, 13983, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[13980,13983]}");
    ...
    getCompletedPayload() {
        ...
        this.s3Parts.forEach((part, partNumber) => { $_$twiz("part", part, 14255, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true}"); $_$twiz("partNumber", partNumber, 14267, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true}"); if (partNumber > 0) {
            [
                "<Part><PartNumber>",
                partNumber,
                "</PartNumber><ETag>",
                part.eTag,
                "</ETag></Part>"
            ].forEach(a => { $_$twiz("a", a, 14466, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[14465,14466]}"); completeDoc.push(a); });
        } });
        completeDoc.push("</CompleteMultipartUpload>");
    ...
    consumeSlots() {
        ...
        if (this.partsToUpload.length !== this.partsInProcess.length &&
            this.status === EVAPORATING) {
            const partsToUpload = Math.min(this.getRemainingSlots(), this.partsToUpload.length);
            if (!partsToUpload) {
                return -1;
            }
            let satisfied = 0;
            ...
            const allInProcess = this.partsToUpload.length === this.partsInProcess.length;
    ...
    canStartPart(part) { $_$twiz("part", part, 16156, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}"); return (!this.partsInProcess.includes(part.partNumber) &&
        !part.awsRequest.errorExceptionStatus()); }
    uploadFile(awsKey) {
        $_$twiz("awsKey", awsKey, 16306, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        this.removeUploadFile();
        const self = this;
        return new InitiateMultipartUpload(self, awsKey).send().then(() => {
            self.uploadInitiated(self.uploadId);
            self.partsToUpload = [];
            return self.uploadParts().then(() => { }, reason => { $_$twiz("reason", reason, 16581, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[16575,16581]}"); throw reason; });
        });
    }
    uploadParts() {
        this.loaded = 0;
    ...
    abortUpload() { return new Promise((resolve, reject) => {
        $_$twiz("resolve", resolve, 17087, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true}");
        $_$twiz("reject", reject, 17095, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true}");
    ...
    resumeInterruptedUpload() { return new ResumeInterruptedUpload(this)
        .send()
        .then(this.uploadParts.bind(this)); }
    reuseS3Object(awsKey) {
        $_$twiz("awsKey", awsKey, 17584, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
        const self = this;
        ...
        function reject(reason) {
            $_$twiz("reason", reason, 17786, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{}");
            self.name = awsKey;
            throw reason;
        }
        return firstS3Part.awsRequest.getPartMd5Digest().then(() => { if (self.firstMd5Digest === firstS3Part.md5_digest) {
            return new ReuseS3Object(self, awsKey)
                .send()
                .then(xhr => {
                $_$twiz("xhr", xhr, 18053, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/FileUpload.ts", "{\"arrow\":true,\"parens\":[18050,18053]}");
