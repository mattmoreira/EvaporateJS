...
export { FAR_FUTURE, PENDING, EVAPORATING, COMPLETE, PAUSED, CANCELED, ERROR, ABORTED, PAUSING, PAUSED_STATUSES, ACTIVE_STATUSES, ETAG_OF_0_LENGTH_BLOB, PARTS_MONITOR_INTERVAL_MS, IMMUTABLE_OPTIONS, S3_EXTRA_ENCODED_CHARS };
