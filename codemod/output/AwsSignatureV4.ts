...
class AwsSignatureV4 extends AwsSignature {
    ...
    error() { this._cr = undefined; }
    getPayload() { return this.awsRequest.getPayload().then(data => { $_$twiz("data", data, 392, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{\"arrow\":true,\"parens\":[388,392]}"); this.payload = data; }); }
    authorizationString() {
        const authParts = [];
        const credentials = this.credentialString();
        const headers = this.canonicalHeaders();
        authParts.push(["AWS4-HMAC-SHA256 Credential=", this.con.aws_key, "/", credentials].join(""));
    ...
    canonicalQueryString() {
        ...
        const sorted = encoded.sort((a, b) => {
            $_$twiz("a", a, 2049, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{\"arrow\":true}");
            $_$twiz("b", b, 2052, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{\"arrow\":true}");
            if (a.name < b.name) {
                return -1;
            }
    ...
    getPayloadSha256Content() {
        const result = this.request.contentSha256 ||
    ...
    canonicalHeaders() {
        ...
        function addHeader(name, value) {
            $_$twiz("name", name, 2808, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{}");
            $_$twiz("value", value, 2815, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{}");
        ...
        const sortedKeys = keys.sort((a, b) => {
            $_$twiz("a", a, 3429, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{\"arrow\":true}");
            $_$twiz("b", b, 3432, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{\"arrow\":true}");
            if (a < b) {
                return -1;
            }
            else if (a > b) {
    ...
    canonicalRequest() {
        ...
        canonParts.push(uri([this.awsRequest.awsUrl, this.awsRequest.getPath(), this.request.path].join(""))
            .pathname);
    ...
    setHeaders(xhr) { $_$twiz("xhr", xhr, 4858, "/Users/matheus.moreira/Projetos/open-source/EvaporateJS/codemod/output/AwsSignatureV4.ts", "{}"); xhr.setRequestHeader("x-amz-content-sha256", this.getPayloadSha256Content()); }
}
